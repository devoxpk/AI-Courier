    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        <div className="flex items-center">
          <Link href="/dispatches" className="mr-4 text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">
            &larr; Back to Dispatches
          </Link>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Dispatch Details</h1>
        </div>
      </div>
